...
export function VipPage() {
  return <PlaceholderPage title="VIP & Segmentation" description="Tier configuration, high-value users, manual VIP adjustment." />;
}

export function RiskPage() {
  return <PlaceholderPage title="Risk Control" description="Abnormal users, triggered rules, restrictions/freeze." />;
}

export function PromotionsPage() {
  return <PlaceholderPage title="Bonus & Promotions" description="Create/edit/disable promotions, bonus rules, user bonus status." />;
}
